    ...
    <>
      ...
      <section className="relative bg-[var(--color-primary-dark)] text-white py-20 lg:py-28">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-green-300 font-semibold text-sm uppercase tracking-widest">Our Services</span>
          <h1 className="text-4xl lg:text-5xl font-bold mt-4 mb-4" style={{ fontFamily: "'DM Sans', sans-serif" }}>Professional Cleaning Solutions</h1>
